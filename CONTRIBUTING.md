...
* Available tasks are in our [project board](https://github.com/epam/sap-commerce-intellij-idea-plugin/projects) or reach out to Mykhailo Lytvyn in project's Slack. 
...
* Ensure to follow [Technical Notes](TECH_NOTES.md).
